      ...
      <div className="mt-8 space-y-8 text-sm leading-7 text-kyn-text-secondary">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              Dados de cadastro e contato: nome, e-mail, telefone/WhatsApp,
              empresa, cargo.
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mt-2">
            A Kynovia pode compartilhar dados pessoais com:
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
        ...
        <section>
          ...
          <p className="mt-2">
            Nos termos da LGPD, o titular de dados pessoais pode solicitar, entre
            outros direitos:
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
